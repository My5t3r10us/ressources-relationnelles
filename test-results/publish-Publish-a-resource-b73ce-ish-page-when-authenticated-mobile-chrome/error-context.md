...
- Name: publish.spec.ts >> Publish a resource >> user can reach the publish page when authenticated
- Location: tests\e2e\publish.spec.ts:9:7
...
Locator: getByRole('heading', { name: /publier|nouvelle ressource/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /publier|nouvelle ressource/i })
