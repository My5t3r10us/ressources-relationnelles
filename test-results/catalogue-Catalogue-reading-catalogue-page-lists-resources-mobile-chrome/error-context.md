...
- Name: catalogue.spec.ts >> Catalogue & reading >> catalogue page lists resources
- Location: tests\e2e\catalogue.spec.ts:4:7
...
Locator: getByRole('heading', { name: /catalogue/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /catalogue/i })
